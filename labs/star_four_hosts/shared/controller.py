    ...
    try:
        ...
        while (True):
            ...
            if (digest_type == 'digest'):
                ...
                smac_table_entry = p4info_helper.buildTableEntry("MyIngress.smac_table", match_fields = {"MAC Address": eth_src_addr}, action = NoAction())
                dmac_forward_entry = p4info_helper.buildTableEntry("MyIngress.dmac_forward", match_fields = {"MAC Address": eth_src_addr}, action = egress_port)
